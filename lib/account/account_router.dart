...
import 'package:flutter_deer/account/page/test_page.dart';
...
class AccountRouter implements IRouterProvider{
  ...
  static String testlResultPage = '/account/text';
  ...
  void initRouter(Router router) {
    ...
    router.define(testlResultPage, handler: Handler(handlerFunc: (_, params) => TestPage()));
  }
