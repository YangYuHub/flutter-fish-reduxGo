...
class UnifiedThemeStyles {
  ...
  //浅灰
  static const Color LIGHT_GREY = const Color.fromRGBO(47, 53, 58, 1);
  //深灰
  static const Color DARK_GREY = const Color.fromRGBO(47, 53, 58, 1);
  //紫色
  static const Color PURPPLE = const Color.fromRGBO(125, 80, 219, 1);
  ...
  ///小字号
  static double smallFontSize = ScreenUtil().setSp(26.0);

  ///小号x
  static double smallxFontSize = ScreenUtil().setSp(20.0);

  ///小号xx
  static double smallxxFontSize = ScreenUtil().setSp(15.0);
